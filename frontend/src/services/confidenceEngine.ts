import { ConfidenceTier, DecisionStatus, IClarificationQuestion, DiagnosticCase } from '../types';
...
export interface ClientConfidenceEvaluation {
  tier: ConfidenceTier;
...
export class ClientConfidenceEngine {
  public static evaluate(
    confidenceScore: number,
    cropName: string,
    suspectedIssue: string,
    symptoms: string[] = []
  ): ClientConfidenceEvaluation {
    ...
    if (score >= CONFIDENCE_THRESHOLDS.HIGH_CONFIDENCE_MIN) {
      return {
        ...
        badgeLabelKey: 'highConfidenceBadge',
        badgeColor: '#059669',
        badgeBg: '#ecfdf5',
        badgeBorder: '#a7f3d0',
        headlineKey: 'highConfidenceHeadline',
        subtextKey: 'highConfidenceSubtext',
      };
      ...
      return {
        ...
        confidenceScore: score,
        badgeLabelKey: 'mediumConfidenceBadge',
        badgeColor: '#d97706',
        badgeBg: '#fffbeb',
        badgeBorder: '#fde68a',
        headlineKey: 'mediumConfidenceHeadline',
        subtextKey: 'mediumConfidenceSubtext',
      ...
      return {
        ...
        confidenceScore: score,
        badgeLabelKey: 'lowConfidenceBadge',
        badgeColor: '#dc2626',
        badgeBg: '#fef2f2',
        badgeBorder: '#fecaca',
        headlineKey: 'lowConfidenceHeadline',
        subtextKey: 'lowConfidenceSubtext',
      };
    }
  }
